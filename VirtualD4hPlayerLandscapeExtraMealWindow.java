...
public class VirtualD4hPlayerLandscapeExtraMealWindow extends PopupWindow implements View.OnClickListener {
    private int amount;
    ...
    private VirtualD4hManualWindow.onFeedManualListener mFeedManualListener;
    ...
    public VirtualD4hPlayerLandscapeExtraMealWindow(Activity activity, long j, int i) {
        ...
        d4ScaleScrollView.setOnScrollListener(new BaseScaleView.OnScrollListener() { // from class: com.petkit.android.activities.virtual.d4sh.widget.VirtualD4hPlayerLandscapeExtraMealWindow.1
            @Override // com.petkit.android.activities.go.widget.BaseScaleView.OnScrollListener
            public void onScaleScroll(int i2) {
                VirtualD4hPlayerLandscapeExtraMealWindow.this.amount = i2;
            }
        });
        ...
        getContentView().findViewById(R.id.tv_selected_time).setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.virtual.d4sh.widget.VirtualD4hPlayerLandscapeExtraMealWindow.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (VirtualD4hPlayerLandscapeExtraMealWindow.this.isShowPicker) {
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.tvSelectedTime.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, CommonUtils.getAppContext().getResources().getDrawable(R.drawable.up_icon), (Drawable) null);
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimeSelectView.setVisibility(8);
                } else {
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.tvSelectedTime.setCompoundDrawablesWithIntrinsicBounds((Drawable) null, (Drawable) null, CommonUtils.getAppContext().getResources().getDrawable(R.drawable.down_icon), (Drawable) null);
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimeSelectView.setVisibility(0);
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setVisibility(0);
                    Calendar calendar = Calendar.getInstance();
                    calendar.setTimeZone(VirtualD4hPlayerLandscapeExtraMealWindow.this.d4sRecord.getActualTimeZone());
                    calendar.add(12, 10);
                    int i2 = calendar.get(11);
                    int i3 = calendar.get(12);
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.tvSelectedTime.setText(TimeUtils.getInstance().secondsToTimeStringWithoutUnit((int) (calendar.getTime().getTime() / 1000)));
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.time = (i2 * 3600) + (i3 * 60);
                    if (Build.VERSION.SDK_INT >= 23) {
                        VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setMinute(i3);
                        VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setHour(i2);
                    } else {
                        VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setCurrentMinute(Integer.valueOf(i3));
                        VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setCurrentHour(Integer.valueOf(i2));
                    }
                }
                VirtualD4hPlayerLandscapeExtraMealWindow.this.isShowPicker = !r9.isShowPicker;
            }
        });
    ...
    private void initView() {
        ...
        this.mTimePicker.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() { // from class: com.petkit.android.activities.virtual.d4sh.widget.VirtualD4hPlayerLandscapeExtraMealWindow.3
            @Override // android.widget.TimePicker.OnTimeChangedListener
            public void onTimeChanged(TimePicker timePicker, int i, int i2) {
                if (VirtualD4hPlayerLandscapeExtraMealWindow.this.mDay != Integer.parseInt(VirtualD4hPlayerLandscapeExtraMealWindow.this.dateFormat.format(Calendar.getInstance().getTime())) || VirtualD4hPlayerLandscapeExtraMealWindow.this.d4sRecord.getState().getPim() != 2 || (i * 3600) + (i2 * 60) >= VirtualD4hPlayerLandscapeExtraMealWindow.this.curTime) {
                    int i3 = i2 * 60;
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.tvSelectedTime.setText(TimeUtils.getInstance().secondsToTimeStringWithoutUnit((i * 3600) + i3));
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.time = (i * 3600) + i3;
                    return;
                }
                if (Build.VERSION.SDK_INT >= 23) {
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setMinute(VirtualD4hPlayerLandscapeExtraMealWindow.this.curMinute);
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setHour(VirtualD4hPlayerLandscapeExtraMealWindow.this.curHourOfDay);
                } else {
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setCurrentMinute(Integer.valueOf(VirtualD4hPlayerLandscapeExtraMealWindow.this.curMinute));
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mTimePicker.setCurrentHour(Integer.valueOf(VirtualD4hPlayerLandscapeExtraMealWindow.this.curHourOfDay));
                }
            }
        });
    ...
    private void saveManualFeed() {
        new ExperienceMoreWindow(this.mActivity, new ExperienceMoreWindow.OnClickListener() { // from class: com.petkit.android.activities.virtual.d4sh.widget.VirtualD4hPlayerLandscapeExtraMealWindow.4
            @Override // com.petkit.android.activities.virtual.widget.ExperienceMoreWindow.OnClickListener
            public void onClickFirstChoice() {
                MallUtils.goToWebOrProductDetail(VirtualD4hPlayerLandscapeExtraMealWindow.this.mActivity, VirtualD4hPlayerLandscapeExtraMealWindow.this.deviceRegularDataResult.getResult().getD4h().getShareUrl().getUrl(), 2);
                VirtualD4hPlayerLandscapeExtraMealWindow.this.dismiss();
            }

            @Override // com.petkit.android.activities.virtual.widget.ExperienceMoreWindow.OnClickListener
            public void onClickSecondChoice() {
                VirtualD4hPlayerLandscapeExtraMealWindow.this.dismiss();
                if (Long.parseLong(UserInforUtils.getCurrentUserId(VirtualD4hPlayerLandscapeExtraMealWindow.this.mActivity)) != FamilyUtils.getInstance().getCurrentFamilyInfo(VirtualD4hPlayerLandscapeExtraMealWindow.this.mActivity).getOwner()) {
                    PetkitToast.showTopToast(VirtualD4hPlayerLandscapeExtraMealWindow.this.mActivity, VirtualD4hPlayerLandscapeExtraMealWindow.this.mActivity.getResources().getString(R.string.Bind_device_family_check_prompt), R.drawable.top_toast_warn_icon, 1);
                } else {
                    VirtualD4hPlayerLandscapeExtraMealWindow.this.mActivity.startActivity(BleDeviceBindNetWorkActivity.newIntent((Context) VirtualD4hPlayerLandscapeExtraMealWindow.this.mActivity, 0L, 26, "", true));
                }
            }
    ...
    public void setFeedManualListener(VirtualD4hManualWindow.onFeedManualListener onfeedmanuallistener) {
