...
public final class MediaType {
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.on("; ").withKeyValueSeparator(URLEncodedUtils.NAME_VALUE_SEPARATOR);
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            tokenizer.consumeCharacter(FileUtil.SLASH_CHAR);
            ...
            while (tokenizer.hasMore()) {
                ...
                tokenizer.consumeCharacter(RFC6265CookieSpecBase.EQUAL_CHAR);
