...
public class T6SmallWidgetView extends BaseSmallWidgetView {

    @SuppressLint({"StaticFieldLeak"})
    public static class T6SmallWidgetViewHolder {
        public static final T6SmallWidgetView instance = new T6SmallWidgetView();
    }

    public static T6SmallWidgetView getInstance() {
        return T6SmallWidgetViewHolder.instance;
    }
    ...
    public void setDeviceData(Context context, HomeDeviceData homeDeviceData) {
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            setDeviceName(this.context.getResources().getString(R.string.T6_name_default));
        }
        boolean z = homeDeviceData.getData().getDeviceShared(27) != null;
        ...
        if (homeDeviceData.getData().getSettings() != null && homeDeviceData.getData().getSettings().getHomeMode() == 1 && homeDeviceData.getData().getSettings().getCameraOff() == 1) {
            cameraOff();
            return;
        }
    ...
    private void showImage(final String str, final String str2, final boolean z) {
        new ImageCacheSimple(CommonUtils.getAppContext()).getImageCachePath(CommonUtil.httpToHttps(str), new ImageCacheSimple.IGetImageCacheListener() { // from class: com.petkit.android.activities.appwidget.mode.small.T6SmallWidgetView$$ExternalSyntheticLambda0
    ...
    public final /* synthetic */ void lambda$showImage$0(String str, String str2, boolean z, String str3) {
        int i;
        if (str3 != null) {
            File fileDecryptImageFile = ImageUtils.decryptImageFile(new File(str3), str);
            if (fileDecryptImageFile != null) {
                Bitmap bitmapBimapSquareRound = CommonUtil.bimapSquareRound(ErrorCode.ERR_USER_PARTNER_ALREADY_BINDED, T6Utils.getRotateBitmap(fileDecryptImageFile.getAbsolutePath(), str2));
                if (z) {
