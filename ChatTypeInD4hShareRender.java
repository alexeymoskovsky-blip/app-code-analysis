...
public class ChatTypeInD4hShareRender extends ChatTypeInBaseRender {
    public TextView chatFeederName;
    public TextView chatFeederShareMsg;
    public View feederShareView;

    public ChatTypeInD4hShareRender(Activity activity, ChatAdapter chatAdapter) {
    ...
    public void fitEvents() {
        super.fitEvents();
        this.feederShareView.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.chat.adapter.render.ChatTypeInD4hShareRender.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
                    String value = JSONUtils.getValue(JSONUtils.getJSONObject(ChatTypeInD4hShareRender.this.chatAdapter.getItem(((Integer) view.getTag()).intValue()).getPayloadContent()), "deviceId");
                    if (value == null || value.isEmpty()) {
                        return;
                    }
                    D4shUtils.startActivityForD4shSharedDeviceId(((ChatTypeInBaseRender) ChatTypeInD4hShareRender.this).activity, D4shHomeActivity.class, Long.valueOf(value).longValue(), 1);
                    new HashMap().put("type", Constants.IM_PAYLOAD_TYPE_API_D4H_SHARE);
    ...
    public void fitDatas(int i) {
        ...
        try {
            ...
            this.chatFeederName.setText(((ChatTypeInBaseRender) this).activity.getString(R.string.D4H_name_default));
