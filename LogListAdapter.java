...
public class LogListAdapter extends LoadMoreBaseAdapter<ChatMsg> {
    ...
    */
    public android.view.View getContentView(int r17, android.view.View r18, android.view.ViewGroup r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.petkit.android.activities.home.adapter.LogListAdapter.getContentView(int, android.view.View, android.view.ViewGroup):android.view.View");
    }
