...
import com.petkit.android.activities.virtual.d3.adapter.VirtualD3HomeRecordAdapter;
...
public class VirtualD3HomeDeviceView extends LinearLayout implements PetkitSlidingUpPanelLayout.PanelSlideListener, View.OnClickListener, BleDeviceHomeMenuView.OnMenuClickListener, VirtualD3HomeRecordAdapter.OnClickListener, BleDeviceHomeOfflineWarnWindow.OfflineClickListener, BarChartView.ChartOnClickListener, VirtualD3HomeRecordAdapter.DeleteRecordViewClick, VirtualD3HomeRecordAdapter.GuidePageListener, D3Histogram.OnPageChanged {
    ...
    private VirtualD3HomeRecordAdapter d3HomeRecordAdapter;
    ...
    private Disposable gifDisposable1;
    ...
    private Disposable startFeedDisposable;
    private float tempY;
    ...
    public void checkGuidePageShowed() {
    }
    ...
    @Override // com.petkit.android.activities.virtual.d3.adapter.VirtualD3HomeRecordAdapter.OnClickListener
    ...
    @RequiresApi(api = 23)
    public VirtualD3HomeDeviceView(Context context) {
        super(context);
    ...
    @RequiresApi(api = 23)
    public VirtualD3HomeDeviceView(Context context, AttributeSet attributeSet) {
    ...
    @RequiresApi(api = 23)
    public VirtualD3HomeDeviceView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void initView() {
        ...
        View viewInflate = LayoutInflater.from(this.mContext).inflate(R.layout.layout_virtual_d3_home_device_view, (ViewGroup) null);
        ...
        D3Histogram d3Histogram = (D3Histogram) this.contentView.findViewById(R.id.d3_histogram);
        this.d3Histogram = d3Histogram;
        d3Histogram.setMaskVisibility(0);
        ...
        this.mainHandler.postDelayed(new Runnable() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.1
            @Override // java.lang.Runnable
            public void run() {
                VirtualD3HomeDeviceView.this.initViewSizeAndPosition();
            }
        }, 200L);
        this.scrollLayout.setScrollviewOnTouchListener(new ScrollViewWithListener2.ScrollviewOnTouchListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.2
            ...
            public void onScrolling(int i, int i2, int i3, int i4) {
                ...
                if (i2 - i4 > 5) {
                    Log.d("scrolling", "up");
                    VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                    virtualD3HomeDeviceView.isUp = true;
                    if (!virtualD3HomeDeviceView.isAniStart && virtualD3HomeDeviceView.bleMenuView.getVisibility() == 0) {
                        Animation animationLoadAnimation = AnimationUtils.loadAnimation(VirtualD3HomeDeviceView.this.activity, R.anim.ble_menu_slide_out_to_bottom);
                        animationLoadAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.2.1
                            ...
                            public void onAnimationEnd(Animation animation) {
                                VirtualD3HomeDeviceView virtualD3HomeDeviceView2 = VirtualD3HomeDeviceView.this;
                                virtualD3HomeDeviceView2.isAniStart = false;
                                virtualD3HomeDeviceView2.bleMenuView.setVisibility(8);
                            }
                        });
                        VirtualD3HomeDeviceView.this.bleMenuView.startAnimation(animationLoadAnimation);
                        VirtualD3HomeDeviceView.this.isAniStart = true;
                    }
                } else {
                    VirtualD3HomeDeviceView.this.isUp = false;
                }
                if (VirtualD3HomeDeviceView.this.d3HomeRecordAdapter.getDateDataList() != null) {
                    int i6 = 0;
                    while (true) {
                        if (i6 >= VirtualD3HomeDeviceView.this.d3HomeRecordAdapter.getDateDataList().size()) {
                            break;
                        }
                        if (VirtualD3HomeDeviceView.this.d3HomeRecordAdapter.getDateDataList().get(i6).getType() == 2) {
                            i5 = i6 + 1;
                            break;
                        }
                        i6++;
                    }
                    if (i5 == 0 || (childAt = VirtualD3HomeDeviceView.this.rvRecordView.getChildAt(i5 - 1)) == null || (((((childAt.getTop() + childAt.getHeight()) + VirtualD3HomeDeviceView.this.rlD3RecordView.getTop()) + VirtualD3HomeDeviceView.this.llHistoryRecordPanel.getTop()) + VirtualD3HomeDeviceView.this.llD3Bottom.getTop()) - VirtualD3HomeDeviceView.this.scrollLayout.getScrollY()) - (VirtualD3HomeDeviceView.this.bleMenuView.getTop() - VirtualD3HomeDeviceView.this.contentView.getTop()) > 0 || DataHelper.getBooleanSF(VirtualD3HomeDeviceView.this.mContext, Consts.D3_REMOVE_RECORD_GUIDE_PAGE_SHOWED) || VirtualD3HomeDeviceView.this.d3Record == null || VirtualD3HomeDeviceView.this.d3Record.getDeviceShared() != null || VirtualD3HomeDeviceView.this.isShowGuide) {
                        return;
                    }
                    VirtualD3HomeDeviceView.this.isShowGuide = true;
                    VirtualD3HomeDeviceView.this.showGuideView(childAt);
                }
            }
            ...
            public void finishScroll(boolean z) {
                Log.d("scrolling", z + "");
                VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                if (virtualD3HomeDeviceView.isAniStart || virtualD3HomeDeviceView.bleMenuView.getVisibility() == 8) {
                    Animation animationLoadAnimation = AnimationUtils.loadAnimation(VirtualD3HomeDeviceView.this.activity, R.anim.ble_menu_slide_in_from_bottom);
                    animationLoadAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.2.2
                        @Override // android.view.animation.Animation.AnimationListener
                        public void onAnimationRepeat(Animation animation) {
                        }
                        ...
                        public void onAnimationEnd(Animation animation) {
                            VirtualD3HomeDeviceView virtualD3HomeDeviceView2 = VirtualD3HomeDeviceView.this;
                            virtualD3HomeDeviceView2.isAniStart = false;
                            virtualD3HomeDeviceView2.bleMenuView.setVisibility(0);
                        }
                    });
                    VirtualD3HomeDeviceView.this.bleMenuView.startAnimation(animationLoadAnimation);
                }
    ...
    public void initViewSizeAndPosition() {
        this.hsvChart.post(new Runnable() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.3
            @Override // java.lang.Runnable
            public void run() {
                VirtualD3HomeDeviceView.this.hsvChart.scrollTo(VirtualD3HomeDeviceView.this.barChartView.getWidth(), 0);
            }
        });
        this.rlTopView.setOnTouchListener(new View.OnTouchListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.4
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                VirtualD3HomeDeviceView.this.mVelocityTracker.addMovement(motionEvent);
                int action = motionEvent.getAction();
                if (action == 0) {
                    VirtualD3HomeDeviceView.this.tempY = motionEvent.getY();
                    VirtualD3HomeDeviceView.this.rlRightTopWindow.setVisibility(8);
                    VirtualD3HomeDeviceView.this.rlLeftBottomWindow.setVisibility(8);
                    VirtualD3HomeDeviceView.this.clickOuterIndex = 0;
                    VirtualD3HomeDeviceView.this.clickInnerIndex = 0;
                    PetkitLog.d("resOffset", "ACTION_DOWN:tempY:" + VirtualD3HomeDeviceView.this.tempY);
                } else if (action == 1) {
                    PetkitLog.d("resOffset", "ACTION_UP");
                    VirtualD3HomeDeviceView.this.mVelocityTracker.computeCurrentVelocity(1000);
                    PetkitLog.d("resOffset", "xVelocity:" + VirtualD3HomeDeviceView.this.mVelocityTracker.getXVelocity() + " yVelocity:" + VirtualD3HomeDeviceView.this.mVelocityTracker.getYVelocity());
                } else if (action == 2) {
                    float y = motionEvent.getY();
                    float unused = VirtualD3HomeDeviceView.this.tempY;
                    VirtualD3HomeDeviceView.this.tempY = y;
                }
                return true;
            }
        });
        this.tvD3Left.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.5
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {
                int height = VirtualD3HomeDeviceView.this.tvD3Left.getHeight();
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) VirtualD3HomeDeviceView.this.ivHelpIcon.getLayoutParams();
                layoutParams.setMargins(ArmsUtils.dip2px(VirtualD3HomeDeviceView.this.mContext, 2.0f), height, layoutParams.rightMargin, layoutParams.bottomMargin);
                VirtualD3HomeDeviceView.this.ivHelpIcon.setLayoutParams(layoutParams);
                VirtualD3HomeDeviceView.this.tvD3Left.getViewTreeObserver().removeOnGlobalLayoutListener(this);
            }
        });
    }

    private void initPannelHeight() {
        this.llD3ViewBtnPanel.getHeight();
        this.llChartPanelHeight = this.llChartPanel.getHeight();
        if (this.isNeedShow) {
            showSurplusGrainWindow(this.activity.getWindow().getDecorView(), ArmsUtils.dip2px(this.mContext, 125.0f));
        }
        initCenterWindowParams(ArmsUtils.dip2px(this.mContext, 30.0f));
    }
    ...
    public void setD3Record(D3Record d3Record) {
        ...
        this.tvHistoryMore.setVisibility(4);
        ...
        if (this.d3HomeRecordAdapter == null) {
            VirtualD3HomeRecordAdapter virtualD3HomeRecordAdapter = new VirtualD3HomeRecordAdapter(this.mContext, d3Record.getDeviceId(), this, this, this, d3Record.getDeviceShared() != null);
            this.d3HomeRecordAdapter = virtualD3HomeRecordAdapter;
            this.rvRecordView.setAdapter(virtualD3HomeRecordAdapter);
        }
        if (d3Record.getState().getPim() == 0) {
            this.feederInlet.setVisibility(8);
            ...
            this.ivMenuHelpIcon.setVisibility(0);
        ...
        if (d3Record.getState().getPim() == 0 && (d3Record.getState().getFeedState() == null || d3Record.getState().getFeedState().getEatTimes() == null || (d3Record.getState().getFeedState().getEatAmountTotal() == 0 && d3Record.getState().getFeedState().getEatTimes().size() == 0))) {
            ...
            SpannableString spannableString5 = new SpannableString(d3Record.getState().getFeedState().getEatTimes().size() + string8 + "/" + D3Utils.calcD3AmountUnit(d3Record.getState().getFeedState().getEatAmountTotal()));
            ...
            spannableString5.setSpan(new RelativeSizeSpan(0.7f), spannableString5.toString().indexOf(string9), spannableString5.toString().indexOf(string9) + string9.length(), 33);
            ...
            SpannableString spannableString6 = new SpannableString(0 + string10 + "/" + D3Utils.calcD3AmountUnit(0));
        ...
        this.fsvVoiceAni.post(new Runnable() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.6
            @Override // java.lang.Runnable
            public void run() {
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) VirtualD3HomeDeviceView.this.fsvVoiceAni.getLayoutParams();
                layoutParams.setMargins(layoutParams.leftMargin, (ArmsUtils.dip2px(VirtualD3HomeDeviceView.this.mContext, 40.0f) + VirtualD3HomeDeviceView.this.fsvVoiceAni.getMeasuredHeight()) * (-1), layoutParams.rightMargin, layoutParams.bottomMargin);
                VirtualD3HomeDeviceView.this.fsvVoiceAni.setLayoutParams(layoutParams);
            }
        });
    }
    ...
    private void checkDeviceWarnState() {
        int i = this.d3Record.getState().getWifi().getRsq() < -70 ? 1 : 0;
        if (i == 0) {
    ...
    */
    public void onClick(android.view.View r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.onClick(android.view.View):void");
    }
    ...
    public void onMenuClick(BleMenuItem bleMenuItem, int i) {
        ...
        if (menuOnClickListener != null) {
            ...
            if (i == 1) {
                ...
                if (deviceRegularDataResult.getResult().getD3().getGifs() != null) {
                    showGifWindow(this.bleMenuView.getMenuView(1), deviceRegularDataResult.getResult().getD3().getGifs().getCallPet(), ArmsUtils.dip2px(this.mContext, 39.0f) * (-1));
                }
                this.menuOnClickListener.onBottomMenuClick(MenuType.CALL_PET);
                return;
            }
            if (i == 2) {
    ...
    private SpannableString getAllFeedAndEatStr(int i, int i2) {
        ...
        SpannableString spannableString = new SpannableString(string + D3Utils.calcD3AmountUnit(i2));
    ...
    public void refreshDateData(D3Statistic d3Statistic, int i) {
        ...
        this.tvHistoryRecord.setText(String.format("%s%s", getResources().getString(R.string.About), d3Statistic.getEatAmount() + "g"));
        refreshBarChart();
    ...
    public D3DailyFeeds getD3DailyFeeds() {
        return this.d3DailyFeeds;
    }
    ...
    public void refreshDateData(D3DailyFeeds d3DailyFeeds) {
        ...
        if (d3DailyFeeds != null) {
            ...
            this.d3HomeRecordAdapter = new VirtualD3HomeRecordAdapter(this.mContext, this.d3Record.getDeviceId(), this, this, this, this.d3Record.getDeviceShared() != null);
            ...
            this.rvRecordView.post(new Runnable() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.9
                @Override // java.lang.Runnable
                public void run() {
                    if (VirtualD3HomeDeviceView.this.rvRecordView.getMeasuredHeight() >= ArmsUtils.dip2px(VirtualD3HomeDeviceView.this.mContext, 300.0f)) {
                        VirtualD3HomeDeviceView.this.rvRecordView.setPadding(0, 0, 0, ArmsUtils.dip2px(VirtualD3HomeDeviceView.this.mContext, 50.0f));
                    }
                }
            });
        }
    ...
    public void startFeedAni() {
        this.startFeedDisposable = Observable.just("").delay(500L, TimeUnit.MILLISECONDS).subscribeOn(AndroidSchedulers.mainThread()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<String>() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.10
            @Override // io.reactivex.functions.Consumer
            public void accept(String str) throws Exception {
                VirtualD3HomeDeviceView.this.pbBucket1.setOpenAnimation(true);
            }
        });
    }
    ...
    public void stopFeedAni() {
        ...
        Disposable disposable = this.startFeedDisposable;
        if (disposable == null || disposable.isDisposed()) {
            return;
        }
        this.startFeedDisposable.dispose();
        this.startFeedDisposable = null;
    }
    ...
    @Override // com.petkit.android.activities.virtual.d3.adapter.VirtualD3HomeRecordAdapter.DeleteRecordViewClick
    ...
    public void onClickWindow(int i) {
        DeviceRegularDataResult deviceRegularDataResult = (DeviceRegularDataResult) JSON.parseObject(DataHelper.getStringSF(this.mContext, Constants.VIRTUAL_DEVICE_DATA), DeviceRegularDataResult.class);
        View childAt = this.rvRecordView.getChildAt(i);
        if (deviceRegularDataResult.getResult().getD3().getGifs() != null) {
            showGifWindow(childAt, deviceRegularDataResult.getResult().getD3().getGifs().getWorkRecord(), ArmsUtils.dip2px(this.mContext, 55.0f));
        }
    }

    @Override // com.petkit.android.activities.virtual.d3.adapter.VirtualD3HomeRecordAdapter.GuidePageListener
    public void onMeasureComplete(Map<Integer, Integer> map, Integer num) {
        ...
        if (d3Record == null || d3Record.getDeviceShared() == null) {
            ...
            this.viewCard.post(new Runnable() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.11
                @Override // java.lang.Runnable
                public void run() {
                }
            });
    ...
    public void showCleanGifView() {
        Observable.timer(500L, TimeUnit.MILLISECONDS).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<Long>() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.12
            ...
            public void onSubscribe(Disposable disposable) {
                VirtualD3HomeDeviceView.this.gifDisposable1 = disposable;
            }

            @Override // io.reactivex.Observer
            public void onNext(Long l) {
                DeviceRegularDataResult deviceRegularDataResult = (DeviceRegularDataResult) JSON.parseObject(DataHelper.getStringSF(VirtualD3HomeDeviceView.this.mContext, Constants.VIRTUAL_DEVICE_DATA), DeviceRegularDataResult.class);
                if (deviceRegularDataResult.getResult().getD3().getGifs() != null) {
                    VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                    virtualD3HomeDeviceView.showGifWindow(virtualD3HomeDeviceView.bleMenuView.getMenuView(0), deviceRegularDataResult.getResult().getD3().getGifs().getFeedAndPetEat(), ArmsUtils.dip2px(VirtualD3HomeDeviceView.this.mContext, 5.0f));
                }
            }
        });
    }
    ...
    public void onDetachedFromWindow() {
        Disposable disposable = this.gifDisposable1;
        if (disposable != null && !disposable.isDisposed()) {
            this.gifDisposable1.dispose();
            this.gifDisposable1 = null;
        }
        Disposable disposable2 = this.gifDisposable;
    ...
    public void showRemoveRecordGuideView() {
        this.viewCard.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.13
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {
                VirtualD3HomeDeviceView.this.removeRecordGuideBuilder = new GuideBuilder();
                VirtualD3HomeDeviceView.this.removeRecordGuideBuilder.setTargetView(VirtualD3HomeDeviceView.this.viewCard).setAlpha(180).setHighTargetCorner(30).setOutsideTouchable(false).setAutoDismiss(false);
                VirtualD3HomeDeviceView.this.removeRecordGuideBuilder.setOnVisibilityChangedListener(new GuideBuilder.OnVisibilityChangedListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.13.1
                    ...
                    public void onDismiss() {
                        VirtualD3HomeDeviceView.this.viewCard.setVisibility(8);
                        DataHelper.setBooleanSF(VirtualD3HomeDeviceView.this.activity, Consts.D3_REMOVE_RECORD_GUIDE_PAGE_SHOWED, Boolean.TRUE);
                    }
                });
                VirtualD3HomeDeviceView.this.removeRecordGuideBuilder.addComponent(new GuideD3TipAndBtnAndLineComponent(new GuideParam(VirtualD3HomeDeviceView.this.getResources().getString(R.string.Pet_feed_records_can_be_slip_deleted), "", 2, 32, 0, 0, "", R.layout.layout_d3_guide_remove_record), new ConfirmListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.13.2
                    @Override // com.petkit.android.activities.petkitBleDevice.w5.guide.ConfirmListener
                    public void onConfirmListener() {
                        if (VirtualD3HomeDeviceView.this.removeRecordGuide != null) {
                            VirtualD3HomeDeviceView.this.removeRecordGuide.dismiss();
                        }
                    }
                }));
                VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                virtualD3HomeDeviceView.removeRecordGuide = virtualD3HomeDeviceView.removeRecordGuideBuilder.createGuide();
                VirtualD3HomeDeviceView.this.removeRecordGuide.show(VirtualD3HomeDeviceView.this.activity);
                VirtualD3HomeDeviceView.this.viewCard.getViewTreeObserver().removeOnGlobalLayoutListener(this);
            }
        });
    }
    ...
    public void showSurplusGrainWindow(View view, int i) {
        ...
        if (popupWindow == null || !popupWindow.isShowing()) {
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.14
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    if (VirtualD3HomeDeviceView.this.popupWindow == null || !VirtualD3HomeDeviceView.this.popupWindow.isShowing()) {
                        return;
                    }
                    VirtualD3HomeDeviceView.this.popupWindow.dismiss();
                    VirtualD3HomeDeviceView.this.popupWindow = null;
                }
            });
        }
    }
    ...
    public void setPromoteView(RelatedProductsInfor relatedProductsInfor) {
        ...
        this.promoteView.setPromoteViewOnItemListener(new PromoteView.PromoteViewOnItemListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.15
    ...
    private void startProductAni() {
        this.tvAddDevice.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.16
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public void onGlobalLayout() {
                int measuredWidth = VirtualD3HomeDeviceView.this.tvAddDevice.getMeasuredWidth();
                VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                virtualD3HomeDeviceView.lastValue = measuredWidth;
                LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) virtualD3HomeDeviceView.tvAddDevice.getLayoutParams();
                layoutParams.width = measuredWidth;
                VirtualD3HomeDeviceView.this.tvAddDevice.setLayoutParams(layoutParams);
                VirtualD3HomeDeviceView.this.startReduceAni(measuredWidth);
                VirtualD3HomeDeviceView.this.tvAddDevice.getViewTreeObserver().removeOnGlobalLayoutListener(this);
            }
        });
    }
    ...
    public void startExpandAni(final int i) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.17
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                int iIntValue = ((Integer) valueAnimator.getAnimatedValue()).intValue();
                VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                if (virtualD3HomeDeviceView.lastValue >= iIntValue || virtualD3HomeDeviceView.tvAddDevice == null) {
                    return;
                }
                LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) VirtualD3HomeDeviceView.this.tvAddDevice.getLayoutParams();
                layoutParams.width = iIntValue;
                VirtualD3HomeDeviceView.this.tvAddDevice.setLayoutParams(layoutParams);
                VirtualD3HomeDeviceView.this.lastValue = iIntValue;
            }
        });
        this.expandValueAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.18
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
                VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                virtualD3HomeDeviceView.isRunning = false;
                virtualD3HomeDeviceView.startReduceAni(i);
            }
        });
    ...
    public void startReduceAni(final int i) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.19
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                int iIntValue = ((Integer) valueAnimator.getAnimatedValue()).intValue();
                VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
        ...
        this.reduceValueAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.20
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
                VirtualD3HomeDeviceView virtualD3HomeDeviceView = VirtualD3HomeDeviceView.this;
                virtualD3HomeDeviceView.isRunning = false;
                virtualD3HomeDeviceView.startExpandAni(i);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void showGifWindow(View view, String str, int i) {
        ...
        builder.isWrap(true);
        builder.customListener(new AnonymousClass21(i2, i3, str));
        this.normalWindow = builder.build();
        PopupWindowCompat.showAsDropDown(this.normalWindow, view, i, -(i3 + view.getHeight()), GravityCompat.START);
    }

    /* JADX INFO: renamed from: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView$21, reason: invalid class name */
    public class AnonymousClass21 implements CustomPopupWindow.CustomPopupWindowListener {
        public final /* synthetic */ int val$height;
        public final /* synthetic */ String val$imageUrl;
        public final /* synthetic */ int val$width;

        public AnonymousClass21(int i, int i2, String str) {
            this.val$width = i;
            this.val$height = i2;
        ...
        public void initPopupView(View view) {
            ...
            imageView.setLayoutParams(layoutParams);
            final int[] iArr = {0};
            Glide.with(VirtualD3HomeDeviceView.this.mContext).load(this.val$imageUrl).diskCacheStrategy(DiskCacheStrategy.SOURCE).listener((RequestListener<? super String, GlideDrawable>) new RequestListener<String, GlideDrawable>() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.21.1
                ...
                public boolean onResourceReady(GlideDrawable glideDrawable, String str, Target<GlideDrawable> target, boolean z, boolean z2) {
                    ...
                    if (VirtualD3HomeDeviceView.this.gifDisposable != null && !VirtualD3HomeDeviceView.this.gifDisposable.isDisposed()) {
                        VirtualD3HomeDeviceView.this.gifDisposable.dispose();
                        VirtualD3HomeDeviceView.this.gifDisposable = null;
                    }
                    VirtualD3HomeDeviceView.this.gifDisposable = Observable.timer(iArr[0], TimeUnit.MILLISECONDS).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<Long>() { // from class: com.petkit.android.activities.virtual.d3.widget.VirtualD3HomeDeviceView.21.1.1
                        @Override // io.reactivex.functions.Consumer
                        public void accept(Long l) throws Exception {
                            if (VirtualD3HomeDeviceView.this.normalWindow == null || !VirtualD3HomeDeviceView.this.normalWindow.isShowing()) {
                                return;
                            }
                            VirtualD3HomeDeviceView.this.normalWindow.dismiss();
                        }
                    });
                    return false;
                }
