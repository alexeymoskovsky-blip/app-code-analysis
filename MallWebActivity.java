package com.petkit.android.activities.mall;
...
public class MallWebActivity extends BaseActivity {
    ...
    public void setupViews() {
        ...
        String str = this.loadPath;
        if (str != null && (!str.contains("https") || !this.loadPath.startsWith("https"))) {
        ...
        setTitleRightImageView(R.drawable.email_icon, new View.OnClickListener() { // from class: com.petkit.android.activities.mall.MallWebActivity.1
            public AnonymousClass1() {
            }

            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ServiceUtils.startToEmail2(MallWebActivity.this);
            }
        });
        this.webView.setDownloadListener(new MyWebViewDownLoadListener());
    }

    /* JADX INFO: renamed from: com.petkit.android.activities.mall.MallWebActivity$1 */
    ...
    private void initWebView() {
        ...
        this.ibBack.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.mall.MallWebActivity.2
        ...
        this.ibForward.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.mall.MallWebActivity.3
            public AnonymousClass3() {
            }

            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MallWebActivity.this.webView.canGoForward()) {
                    MallWebActivity.this.webView.goForward();
                }
            }
        });
        this.ibClose.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.mall.MallWebActivity.4
            public AnonymousClass4() {
            }

            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (MallWebActivity.this.isFinishLoad) {
                    MallWebActivity.this.webView.loadUrl(MallWebActivity.this.finalUrl);
                } else {
                    MallWebActivity.this.webView.goBack();
                }
            }
        });
        this.ibShare.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.mall.MallWebActivity.5
            public AnonymousClass5() {
            }

            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                CallbackManager callbackManager = MallWebActivity.this.callbackManager;
                MallWebActivity mallWebActivity = MallWebActivity.this;
                new ShareWebPopMenu(callbackManager, mallWebActivity, mallWebActivity.title, MallWebActivity.this.finalUrl, null, MallWebActivity.this.description).show();
            }
        });
        ...
        this.webView.setWebViewClient(new WebViewClient() { // from class: com.petkit.android.activities.mall.MallWebActivity.6
            ...
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                ...
                MallWebActivity.this.finalUrl = str;
            }
        });
        this.webView.setWebChromeClient(new WebChromeClient() { // from class: com.petkit.android.activities.mall.MallWebActivity.7
            public AnonymousClass7() {
            }

            public void openFileChooser(ValueCallback<Uri> valueCallback) {
                MallWebActivity.this.mUploadMessage = valueCallback;
                Intent intent = new Intent("android.intent.action.GET_CONTENT");
                intent.addCategory("android.intent.category.OPENABLE");
                intent.setType("image/*");
                MallWebActivity.this.startActivityForResult(Intent.createChooser(intent, "File Chooser"), 256);
            }
            ...
            public void openFileChooser(ValueCallback valueCallback, String str) {
                ...
                intent.addCategory("android.intent.category.OPENABLE");
                intent.setType("*/*");
                MallWebActivity.this.startActivityForResult(Intent.createChooser(intent, "File Browser"), 256);
            }
            ...
            public void onReceivedTitle(WebView webView, String str) {
                ...
                if (MallWebActivity.this.isEmpty(str)) {
                    return;
                }
                MallWebActivity.this.setTitle(str);
            }

            @Override // android.webkit.WebChromeClient
            public void onProgressChanged(WebView webView, int i) {
                if (i != 100) {
                    MallWebActivity.this.isFinishLoad = false;
                    MallWebActivity.this.ibClose.setImageResource(R.drawable.blue_close_icon);
                    if (MallWebActivity.this.loadingProgressBar.getVisibility() == 8) {
                        MallWebActivity.this.loadingProgressBar.setVisibility(0);
                    }
                    MallWebActivity.this.loadingProgressBar.setProgress(i);
                } else {
                    ShopifyUtils.setIsHaveEnterWeb(true);
                    MallWebActivity.this.ibClose.setImageResource(R.drawable.blue_refresh_icon);
                    MallWebActivity.this.isFinishLoad = true;
                    MallWebActivity.this.loadingProgressBar.setVisibility(8);
                    if (MallWebActivity.this.webView.canGoForward()) {
                        MallWebActivity.this.ibForward.setImageResource(R.drawable.forward_clickable_icon);
                    } else {
                        MallWebActivity.this.ibForward.setImageResource(R.drawable.forward_unclickable_icon);
                    }
                    if (MallWebActivity.this.webView.canGoBack()) {
                        MallWebActivity.this.ibBack.setImageResource(R.drawable.back_clickable_icon);
                    } else {
                        MallWebActivity.this.ibBack.setImageResource(R.drawable.back_unclickable_icon);
                    }
                }
    ...
    /* JADX INFO: renamed from: com.petkit.android.activities.mall.MallWebActivity$2 */
    ...
    /* JADX INFO: renamed from: com.petkit.android.activities.mall.MallWebActivity$3 */
    ...
    /* JADX INFO: renamed from: com.petkit.android.activities.mall.MallWebActivity$4 */
    ...
    /* JADX INFO: renamed from: com.petkit.android.activities.mall.MallWebActivity$5 */
    ...
    /* JADX INFO: renamed from: com.petkit.android.activities.mall.MallWebActivity$6 */
    ...
    /* JADX INFO: renamed from: com.petkit.android.activities.mall.MallWebActivity$7 */
    ...
    public class MyWebViewDownLoadListener implements DownloadListener {
        ...
        public /* synthetic */ MyWebViewDownLoadListener(MallWebActivity mallWebActivity, AnonymousClass1 anonymousClass1) {
            this();
        }
