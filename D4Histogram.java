...
import com.petkit.android.activities.petkitBleDevice.d4.adapter.D4HistogramPagerAdapter;
...
public class D4Histogram extends RelativeLayout implements BaseBarView.ChartOnClickListener, D4HistogramPagerAdapter.OnFlagChange {
    ...
    private D4HistogramPagerAdapter pagerAdpater;
    ...
    public D4Histogram(Context context) {
        super(context);
    ...
    public D4Histogram(Context context, AttributeSet attributeSet) {
    ...
    public D4Histogram(Context context, AttributeSet attributeSet, int i) {
    ...
    public void updateBarChartData(int i) {
        if (this.pagerAdpater == null || this.dataType != i) {
            ...
            D4HistogramPagerAdapter d4HistogramPagerAdapter = new D4HistogramPagerAdapter(this.context, k3DeviceId.longValue(), this, i, this.showMonthTipWindow, this.showWeekTipWindow, this);
            this.pagerAdpater = d4HistogramPagerAdapter;
            this.vpK3Bar.setAdapter(d4HistogramPagerAdapter);
            this.vpK3Bar.setCurrentItem(this.pagerAdpater.getCount() - 1);
            this.disposable = Observable.timer(50L, TimeUnit.MILLISECONDS).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<Long>() { // from class: com.petkit.android.activities.petkitBleDevice.d4.widget.D4Histogram.1
                @Override // io.reactivex.functions.Consumer
                public void accept(Long l) throws Exception {
                    if (D4Histogram.this.vpK3Bar == null || D4Histogram.this.pagerAdpater == null) {
                        return;
                    }
                    D4Histogram.this.vpK3Bar.setCurrentItem(D4Histogram.this.pagerAdpater.getCount() - 2);
                }
            });
            this.currentPostion = this.pagerAdpater.getCount() - 1;
            this.vpK3Bar.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: com.petkit.android.activities.petkitBleDevice.d4.widget.D4Histogram.2
                ...
                public void onPageSelected(int i2) {
                    D4Histogram d4Histogram = D4Histogram.this;
                    d4Histogram.pageChange = d4Histogram.currentPostion != i2;
                    D4Histogram.this.currentPostion = i2;
                }
                ...
                public void onPageScrollStateChanged(int i2) {
                    ...
                    int count = (D4Histogram.this.currentPostion - D4Histogram.this.pagerAdpater.getCount()) + 1;
                    D4Histogram.this.clearMap();
                    if (D4Histogram.this.onPageChanged != null) {
                        D4Histogram.this.onPageChanged.change(count);
                    }
                }
            });
        }
        D4HistogramPagerAdapter d4HistogramPagerAdapter2 = this.pagerAdpater;
        if (d4HistogramPagerAdapter2 != null) {
            d4HistogramPagerAdapter2.notifyDataSetChanged();
        }
        this.dataType = i;
    }
    ...
    public void drawFinish(List<Float> list) {
        if (this.pagerAdpater.getPositionMap().containsKey(this.dataType + "-" + this.currentPostion)) {
            ...
            this.rlScale.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.petkit.android.activities.petkitBleDevice.d4.widget.D4Histogram.3
                @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
                public void onGlobalLayout() {
                    D4Histogram d4Histogram = D4Histogram.this;
                    d4Histogram.yAsixDesWidth = d4Histogram.rlScale.getWidth();
                    D4Histogram.this.rlScale.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                }
            });
        }
    }

    @Override // com.petkit.android.activities.petkitBleDevice.d4.adapter.D4HistogramPagerAdapter.OnFlagChange
