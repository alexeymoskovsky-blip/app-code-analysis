...
final class ChronoZonedDateTimeImpl<D extends ChronoLocalDate> extends ChronoZonedDateTime<D> implements Serializable {
    ...
    public static <R extends ChronoLocalDate> ChronoZonedDateTime<R> ofBest(ChronoLocalDateTimeImpl<R> chronoLocalDateTimeImpl, ZoneId zoneId, ZoneOffset zoneOffset) {
        ...
        Jdk8Methods.requireNonNull(zoneOffset, IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET);
    ...
    public static <R extends ChronoLocalDate> ChronoZonedDateTimeImpl<R> ofInstant(Chronology chronology, Instant instant, ZoneId zoneId) {
        ...
        Jdk8Methods.requireNonNull(offset, IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET);
    ...
    public final ChronoZonedDateTimeImpl<D> create(Instant instant, ZoneId zoneId) {
    ...
    public ChronoZonedDateTimeImpl(ChronoLocalDateTimeImpl<D> chronoLocalDateTimeImpl, ZoneOffset zoneOffset, ZoneId zoneId) {
        ...
        this.offset = (ZoneOffset) Jdk8Methods.requireNonNull(zoneOffset, IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET);
    ...
    /* JADX INFO: renamed from: org.threeten.bp.chrono.ChronoZonedDateTimeImpl$1 */
