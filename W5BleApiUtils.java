...
public class W5BleApiUtils implements IRepository {
    ...
    public W5BleApiUtils() {
        this.mSendSequence = new AtomicInteger(0);
    }

    public static class W5bleApiUtilsHolder {
        public static W5BleApiUtils instance = new W5BleApiUtils();
    }

    public static W5BleApiUtils getInstance() {
        return W5bleApiUtilsHolder.instance;
    }
    ...
    public void bleConnect(long j, String str, final OnConnectListener onConnectListener) {
        ...
        map.put("bleId", "" + j);
        map.put("type", Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        map.put("mac", str);
        AsyncHttpUtil.post(ApiTools.SAMPLE_API_BLE_CONNECT_START, (Map<String, String>) map, (AsyncHttpResponseHandler) new AsyncHttpRespHandler() { // from class: com.petkit.android.activities.petkitBleDevice.w5.utils.W5BleApiUtils.1
    ...
    public void bleConnectStatus(long j, String str, final OnBleListener onBleListener) {
        ...
        map.put("type", Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        map.put("mac", str);
        AsyncHttpUtil.post(ApiTools.SAMPLE_API_BLE_CONNECT_POLL, (Map<String, String>) map, (AsyncHttpResponseHandler) new AsyncHttpRespHandler() { // from class: com.petkit.android.activities.petkitBleDevice.w5.utils.W5BleApiUtils.2
            @Override // com.petkit.android.api.http.AsyncHttpRespHandler, com.loopj.android.http.AsyncHttpResponseHandler
            public void onSuccess(int i, Header[] headerArr, byte[] bArr) {
                super.onSuccess(i, headerArr, bArr);
    ...
    public void cancelBleConnect(W5Record w5Record, final OnBleListener onBleListener) {
        HashMap map = new HashMap();
        map.put("bleId", "" + w5Record.getDeviceId());
        map.put("type", Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        map.put("mac", w5Record.getMac());
        AsyncHttpUtil.post(ApiTools.SAMPLE_API_BLE_CONNECT_CANCEL, (Map<String, String>) map, (AsyncHttpResponseHandler) new AsyncHttpRespHandler() { // from class: com.petkit.android.activities.petkitBleDevice.w5.utils.W5BleApiUtils.3
            @Override // com.petkit.android.api.http.AsyncHttpRespHandler, com.loopj.android.http.AsyncHttpResponseHandler
            public void onSuccess(int i, Header[] headerArr, byte[] bArr) {
                super.onSuccess(i, headerArr, bArr);
                onBleListener.onResult((BleRsp) this.gson.fromJson(this.responseResult, BleRsp.class));
    ...
    public void bleUpdate(W5Record w5Record) {
        ...
        map.put("type", Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        map.put("mac", w5Record.getMac());
        AsyncHttpUtil.post(ApiTools.SAMPLE_API_BLE_UPDATE, (Map<String, String>) map, (AsyncHttpResponseHandler) new AsyncHttpRespHandler() { // from class: com.petkit.android.activities.petkitBleDevice.w5.utils.W5BleApiUtils.4
            @Override // com.petkit.android.api.http.AsyncHttpRespHandler, com.loopj.android.http.AsyncHttpResponseHandler
            public void onSuccess(int i, Header[] headerArr, byte[] bArr) {
                super.onSuccess(i, headerArr, bArr);
            }
    ...
    public void ownSupportBleDevice(final OwnSupportDeviceListener ownSupportDeviceListener) {
        ...
        AsyncHttpUtil.post(ApiTools.SAMPLE_API_BLE_QUERY_SUPPORT_DEVICE, (Map<String, String>) map, (AsyncHttpResponseHandler) new AsyncHttpRespHandler() { // from class: com.petkit.android.activities.petkitBleDevice.w5.utils.W5BleApiUtils.6
            @Override // com.petkit.android.api.http.AsyncHttpRespHandler, com.loopj.android.http.AsyncHttpResponseHandler
            public void onSuccess(int i, Header[] headerArr, byte[] bArr) {
                super.onSuccess(i, headerArr, bArr);
