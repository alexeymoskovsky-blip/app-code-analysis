...
public final class HijrahChronology extends Chronology implements Serializable {
    public static final HashMap<String, String[]> ERA_FULL_NAMES;
    public static final HashMap<String, String[]> ERA_NARROW_NAMES;
    public static final HashMap<String, String[]> ERA_SHORT_NAMES;
