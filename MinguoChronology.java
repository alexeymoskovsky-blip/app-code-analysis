...
public final class MinguoChronology extends Chronology implements Serializable {
    ...
    /* JADX INFO: renamed from: org.threeten.bp.chrono.MinguoChronology$1 */
        ...
        if (map.containsKey(chronoField7)) {
            ...
            if (map.containsKey(chronoField9)) {
                ...
                if (map.containsKey(chronoField10)) {
                    ...
                    MinguoDate minguoDatePlus = date(iCheckValidIntValue4, iCheckValidIntValue5, 1).plus(((chronoField9.checkValidIntValue(map.remove(chronoField9).longValue()) - 1) * 7) + (chronoField10.checkValidIntValue(map.remove(chronoField10).longValue()) - 1), (TemporalUnit) ChronoUnit.DAYS);
