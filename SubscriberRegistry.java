...
final class SubscriberRegistry {
    ...
    public void unregister(Object obj) {
        for (Map.Entry<Class<?>, Collection<Subscriber>> entry : findAllSubscribers(obj).asMap().entrySet()) {
            ...
            if (copyOnWriteArraySet == null || !copyOnWriteArraySet.removeAll(value)) {
                ...
                StringBuilder sb = new StringBuilder(strValueOf.length() + 65);
    ...
    /* JADX INFO: renamed from: com.google.common.eventbus.SubscriberRegistry$1 */
    ...
    /* JADX INFO: renamed from: com.google.common.eventbus.SubscriberRegistry$2 */
