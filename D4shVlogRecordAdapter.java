...
public class D4shVlogRecordAdapter extends BaseAnimaRecyclerAdapter<HighlightRecord> {
    ...
    public D4shVlogRecordAdapter(Activity activity, D4shRecord d4shRecord) {
        super(activity);
    ...
    public void showData(RecyclerView.ViewHolder viewHolder, int i, List list) {
        if (viewHolder instanceof HighlightRecordViewHolder) {
            ...
            if (highlightRecord.getCreatedAt() < 0) {
                ...
                highlightRecordViewHolder.tvMonth.setVisibility(8);
            } else {
                String dayStrByTimestamp = DateUtil.getDayStrByTimestamp(this.mActivity, highlightRecord.getCreatedAt() * 1000);
                String monthStrByTimestamp = DateUtil.getMonthStrByTimestamp(this.mActivity, highlightRecord.getCreatedAt() * 1000);
                highlightRecordViewHolder.tvDate.setText(dayStrByTimestamp);
                highlightRecordViewHolder.tvDate.setVisibility(0);
                highlightRecordViewHolder.tvMonth.setText(monthStrByTimestamp);
                highlightRecordViewHolder.tvMonth.setVisibility(0);
            }
            ...
            if (!TextUtils.isEmpty(highlightRecord.getVideoUrl())) {
                ...
                highlightRecordViewHolder.ivPreview.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.d4sh.adapter.D4shVlogRecordAdapter$$ExternalSyntheticLambda0
            ...
            if (vlogMarkRecord != null) {
                ...
                if (vlogMarkRecord.getStatus() == 2) {
                    ...
                    highlightRecordViewHolder.vlogPromptBtn.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.d4sh.adapter.D4shVlogRecordAdapter$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
            ...
            if (z) {
                ...
                if (highlightRecord.getId() != 0) {
                    ...
                    highlightRecordViewHolder.vlogPromptBtn.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.d4sh.adapter.D4shVlogRecordAdapter$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
        ...
        if (viewHolder instanceof HighlightEmptyViewHolder) {
            ...
            highlightEmptyViewHolder.tvEmptyContext.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.d4sh.adapter.D4shVlogRecordAdapter$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public final /* synthetic */ void lambda$showData$0(HighlightRecord highlightRecord, View view) {
    ...
    public final /* synthetic */ void lambda$showData$2(HighlightRecord highlightRecord, View view) {
        startVlogGenerate(highlightRecord);
    }

    public final /* synthetic */ void lambda$showData$3(View view) {
    ...
    public View createView(ViewGroup viewGroup, int i) {
        ...
        return LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_home_daily_highlight, viewGroup, false);
    }
