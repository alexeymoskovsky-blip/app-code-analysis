...
public class W7hHomeBannerPageAdapter extends PagerAdapter {
    ...
    public W7hHomeBannerPageAdapter(Context context, List<D4shBannerData.BannerData> list, W7hRecord w7hRecord, int i, OnItemClickListener onItemClickListener) {
    ...
    public Object instantiateItem(ViewGroup viewGroup, final int i) {
        ...
        PetkitLog.d("W7hHomeBannerPageAdapter", sb.toString());
        ...
        if (list.get(list.size() > 1 ? i2 : i) instanceof D4shBannerData.ServiceStatusData) {
            ...
            if (status == 1) {
                ...
                textView3.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.w7h.adapter.W7hHomeBannerPageAdapter$$ExternalSyntheticLambda0
                ...
                textView2.setText(this.context.getResources().getString(R.string.Period_of_validity, this.dateFormat.format(new Date(Long.parseLong(this.w7hRecord.getCloudProduct().getWorkIndate()) * 1000))));
                textView3.setText(R.string.Immediate_renewal);
                textView3.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.w7h.adapter.W7hHomeBannerPageAdapter$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                ...
                if (this.w7hRecord.getCloudProduct() != null) {
                    textView2.setText(this.context.getResources().getString(R.string.Expired_on_prompt, this.dateFormat.format(new Date(Long.parseLong(this.w7hRecord.getCloudProduct().getWorkIndate()) * 1000))));
                }
                textView3.setText(R.string.Immediate_renewal);
                textView3.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.w7h.adapter.W7hHomeBannerPageAdapter$$ExternalSyntheticLambda2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
            ...
            if (list3.get(list3.size() > 1 ? i2 : i) instanceof D4shBannerData.FreeActivity) {
                ...
                if (list4.get(list4.size() > 1 ? i2 : i).getImageRet() != null) {
                    ...
                    if (this.onItemClickListener != null) {
                        newRoundImageview.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.w7h.adapter.W7hHomeBannerPageAdapter$$ExternalSyntheticLambda3
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                ...
                if (list8.get(list8.size() > 1 ? i2 : i).getImageRet() != null) {
                    ...
                    if (this.onItemClickListener != null) {
                        newRoundImageview.setOnClickListener(new View.OnClickListener() { // from class: com.petkit.android.activities.petkitBleDevice.w7h.adapter.W7hHomeBannerPageAdapter$$ExternalSyntheticLambda4
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$instantiateItem$0(View view) {
        if (this.w7hRecord.getRealDeviceShared() != null || FamilyUtils.getInstance().checkIsSharedDevice(this.context, this.w7hRecord.getDeviceId(), this.deviceType)) {
            PetkitToast.showTopToast(CommonUtils.getAppContext(), CommonUtils.getAppContext().getString(R.string.D4sh_no_cloud_buy_tips), R.drawable.top_toast_warn_icon, 1);
        } else {
            redirectToPurchasePage(this.deviceType, this.w7hRecord.getDeviceId());
        }
    }
